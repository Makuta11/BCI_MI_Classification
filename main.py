...
torch.save(model.state_dict(), 'outputs/SeqSeqModel_1lay_seq200_batch10000_epoch10_sd.pt')
print("saved model")
...
with open('modelSaves/ModelOutput_1lay_seq200_batch10000_epoch10.pickle', 'wb') as handle:
